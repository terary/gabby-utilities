...
import { GInputSelectSingle, GInputSelectSingleProps } from './GInputSelectGeneric';
...
describe('GInputSelectControl', () => {
  ...
  describe('Options', () => {
    ...
    it('Should have list items count + 1 for empty when "allowEmpty" undefined', () => {
      ...
      act(() => {
        setupRender({ options, allowEmpty: true });
      });
...
const setupRender = (
  ...
  //GInputSelectSingle, GInputSelectSingleProps
  return render(
    <GInputSelectSingle {...(effectiveProps as GInputSelectSingleProps)} />
  );
};
